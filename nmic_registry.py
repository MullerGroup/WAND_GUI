...
class NmicRegistry_v2():
    def __init__(self, parent=None):
        ...
        self.regs = [ Register(0x00, "CHIP_ID",    0X0000, [("CHIP_ID", 8),("CHIP_REV1",4),("CHIP_REV2",4)], self),
                      Register(0x01, "STATUS",     0x0000, [("STIM_ACTV",1),("",8),("ERR_POR",1),("ERR_CRC",1),("ERR_CFG",1),("ERR_COMP",4)], self),
                      Register(0x02, "PWR_CONFIG", 0x0000, [("",2),("LV_CLKSEL",2),("HV_CLKSEL",3),("HV_TRI",1),("HV_DIS",1),("HV_VOLT",2),("FORCE_CP",1),("FORCE_LDO",1),("FORCE_POR3",1),("FORCE_POR1",1),("LV_RATIO",1)], self),
                      Register(0x03, "TEST_SEL",   0x0000, [("BG_SF_BYP",1),("AN_SF_BYP",1),("",4),("AN_OUT_SEL",4),("DTEST_SEL",6)], self),
                      ...
                      Register(0x0C, "REC_CONFIG", 0x0000, [("",7),("CHOP_CLK",1),("REC_EN",1),("Z_MAG",3),("INT_RST",1),("EN_LDO",1),("SYNC_MODE",1),("WIDE_IN",1)], self),
                      ...
                      Register(0x0E, "NULL",       0x0000, [("",16)], self),
                      ...
                      Register(0x1F, "STIM_CFG15", 0x0000, [("",16)], self)
                    ]