...
class Ui_DataVisualizer(object):
    def setupUi(self, DataVisualizer):
        ...
        self.gridLayout.addWidget(self.testBtn, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.noise, 2, 2, 1, 1)
        self.thd = QtGui.QCheckBox(self.dockWidgetContents)
        self.thd.setCheckable(True)
        self.thd.setObjectName(_fromUtf8("thd"))
        self.gridLayout.addWidget(self.thd, 4, 1, 1, 1)
...
" shift+scroll to scroll faster", None))
        ...
        self.noise.setText(_translate("DataVisualizer", "Print Noise", None))
        self.thd.setText(_translate("DataVisualizer", "Print THD", None))
