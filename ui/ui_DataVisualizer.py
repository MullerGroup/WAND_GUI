...
" shift+scroll to scroll faster", None))
        ...
        self.numPlotsDisplayed.setItemText(0, _translate("DataVisualizer", "3", None))
        self.numPlotsDisplayed.setItemText(1, _translate("DataVisualizer", "1", None))
        self.numPlotsDisplayed.setItemText(2, _translate("DataVisualizer", "2", None))
        self.numPlotsDisplayed.setItemText(3, _translate("DataVisualizer", "4", None))
        self.numPlotsDisplayed.setItemText(4, _translate("DataVisualizer", "8", None))
        self.numPlotsDisplayed.setItemText(5, _translate("DataVisualizer", "16", None))
