...
class Ui_DataVisualizer(object):
    def setupUi(self, DataVisualizer):
        ...
        self.gridLayout.addWidget(self.artifactBtn, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.clearBtn, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.stim, 2, 1, 1, 1)
...
" shift+scroll to scroll faster", None))
        ...
        self.stim.setText(_translate("DataVisualizer", "Stimulate in Stream", None))
