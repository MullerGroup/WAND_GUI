...
class Ui_DataVisualizer(object):
    def setupUi(self, DataVisualizer):
        ...
        self.gridLayout.addWidget(self.samples, 5, 3, 1, 1)
        self.label_4 = QtGui.QLabel(self.dockWidgetContents)
        self.label_4.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.gridLayout.addWidget(self.label_4, 1, 2, 4, 1)
        ...
        self.numPlotsDisplayed.addItem(_fromUtf8(""))
        self.numPlotsDisplayed.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.numPlotsDisplayed, 1, 3, 4, 1)
        ...
        self.gridLayout.addWidget(self.singleBtn, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.autoBtn, 4, 1, 1, 1)
